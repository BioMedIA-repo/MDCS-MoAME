...
def parse_args():
    ...
    parser.add_argument("--data_root_dir", type=str, default="", help="Data directory to WSI features (extracted via CLAM")
    ...
    parser.add_argument("--dataset", type=str, default="tcga_luad", help='Which cancer type within ./splits/<which_dataset> to use for training. Used synonymously for "task" (Default: tcga_blca_100)',)
    ...
    # Model Parameters.
    parser.add_argument("--model",type=str,default="MDCS_MoAME",help="Type of model (Default: mcat)",
    )
    ...
    parser.add_argument("--beta", type=float, default=0.5, help="hyper-parameter of loss function")
    ...
    parser.add_argument("--use_h5", default=True, help="Enable weighted sampling")
